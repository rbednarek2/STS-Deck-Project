...
<nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
    ...
    <div class="collapse navbar-collapse" id="navBar">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
                <a class="nav-link" href="itemDetail.html">Item Detail</a>
            </li>
            <li class="nav-item">
            ...
            <!--<li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdown01">
                    <a class="dropdown-item" href="#">Action</a> "THIS IS A TEST"
...
<div class="container">
    ...
    <div class="jumbotron">
        ...
        <img src="https://steamcdn-a.akamaihd.net/steam/apps/646570/header.jpg?t=1530082099">
        <br><h3>This site will be used to help plan decks for Slay the Spire.</h3>
        <hr>
        <h2>What is Slay the Spire?</h2>
        <p>
